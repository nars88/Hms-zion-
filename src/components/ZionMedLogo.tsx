...
export default function ZionMedLogo({ size = 'md', showText = true, className = '' }: ZionMedLogoProps) {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      {/* Logo SVG - Stylized Z with medical cross */}
      <svg
      ...
      >
        ...
        {/* Medical cross - Elegant and integrated */}
        ...
        <defs>
          <linearGradient id="zGradient" x1="13" y1="13" x2="27" y2="27">
            <stop offset="0%" stopColor="#06B6D4" stopOpacity="1" />
            <stop offset="50%" stopColor="#0891B2" stopOpacity="1" />
            <stop offset="100%" stopColor="#10B981" stopOpacity="1" />
          </linearGradient>
          <linearGradient id="crossGradient" x1="16" y1="15" x2="24" y2="25">
      ...
      {showText && (
        <div className="flex flex-col">
          <span className={`font-semibold text-primary ${textSizeClasses[size]} tracking-tight`}>
            Zion Med
          </span>
