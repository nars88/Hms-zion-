...
// Mock lab results with LOINC codes
const mockLabResults: LabTest[] = [
  ...
  },
  {
    id: '2',
    testName: 'Hemoglobin',
    loincCode: '718-7', // LOINC code for Hemoglobin
    category: 'Hematology',
    value: '8.5',
    unit: 'g/dL',
    ...
    version: 2,
    editedBy: 'Dr. Smith',
    editedAt: '2024-01-15 09:20',
    editHistory: [
      {
        version: 1,
        editedBy: 'Lab Tech',
        editedAt: '2024-01-15 09:15',
        previousValue: '8.2',
        newValue: '8.5',
        reason: 'Re-analyzed sample',
      },
    ],
    aiAnalysis: {
      findings: 'Severe anemia detected - Critical value below reference range',
      risk: 'High',
      confidence: 98,
    },
  },
  {
    ...
    loincCode: '2339-0', // LOINC code for Glucose
    category: 'Chemistry',
    value: '145',
    unit: 'mg/dL',
    ...
    version: 1,
    aiAnalysis: {
      findings: 'Elevated glucose levels - Possible diabetes',
      risk: 'Medium',
      confidence: 85,
    },
  },
  {
    ...
    loincCode: '94500-6', // LOINC code for COVID-19
    category: 'Virology',
    value: 'Positive',
    unit: '',
    ...
    version: 1,
    aiAnalysis: {
      findings: 'Positive result - Immediate isolation recommended',
      risk: 'High',
      confidence: 99,
    },
  },
