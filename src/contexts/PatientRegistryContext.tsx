...
export function PatientRegistryProvider({ children }: { children: ReactNode }) {
  ...
  // Helper function to normalize Arabic characters (ي/ى, ا/أ/إ)
  const normalizeArabic = (text: string): string => {
    if (!text) return ''
    return text
      .replace(/[إأآا]/g, 'ا') // Normalize all forms of ا
