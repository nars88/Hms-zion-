    ...
    <div className="min-h-full bg-slate-950">
      <main className="flex-1 overflow-y-auto p-8">
        <section className="rounded-2xl border border-slate-800/60 bg-slate-900/40 p-6 shadow-xl shadow-black/20">
          <div className="mb-6 flex w-full flex-col gap-3 sm:flex-row sm:items-stretch">
            ...
            <button
              ...
              className="h-11 shrink-0 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 px-5 text-sm font-semibold text-white shadow-lg shadow-violet-900/30 transition hover:from-violet-500 hover:to-indigo-500 sm:self-center"
            >
              Add Employee
            </button>
          </div>
