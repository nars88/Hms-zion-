...
import { LayoutDashboard, DollarSign, Users, CalendarCheck, TrendingUp } from 'lucide-react'
...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-full bg-slate-950 w-full">
      <div className="max-w-7xl mx-auto px-6 py-8 md:px-8 md:py-10 w-full">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-white flex items-center gap-3">
            <LayoutDashboard size={28} className="text-cyan-400" />
            Admin Dashboard
          </h1>
          <p className="mt-1 text-sm text-slate-400">Overview and key metrics</p>
        </header>
