...
const REDIRECT_MAP: Record<string, string> = {
  ...
  [USER_ROLES.SECRETARY]: '/secretary/clinic-queue',
    ...
    try {
      ...
      if (redirectPath) {
        ...
        if (userEmail === 'doctor@zion.med') {
          defaultPath = '/er/clinic'
        } else if (userEmail === 'nurse@zion.med') {
          defaultPath = '/er/mobile-tasks'
      ...
      <div className="relative z-10 flex w-full max-w-md max-h-full min-h-0 flex-col justify-center">
        <div className="bg-slate-900/60 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6 sm:p-8 md:p-10 shadow-2xl shadow-black/50">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2 tracking-tight">Hospital Management System</h1>
            <p className="text-sm text-slate-400">Secure access to your dashboard</p>
          </div>
